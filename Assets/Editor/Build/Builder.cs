...
using MyOwlcatModification.Editor.Build.Tasks;
using UnityEditor;
...
namespace MyOwlcatModification.Editor.Build
{
	public static class Builder
	{
			...
			params IContextObject[] contextObjects)
		{
			...
			if (Directory.Exists(intermediateBuildFolder))
				Directory.Delete(intermediateBuildFolder, true);
			...
			var modParameters = new DefaultModificationParameters(manifest, settings, sourceFolder);
			...
			var toDelete = Path.Combine(targetFolder, modParameters.TargetFolderName);
