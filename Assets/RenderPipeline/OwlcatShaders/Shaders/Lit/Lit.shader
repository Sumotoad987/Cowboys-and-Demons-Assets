Shader "Owlcat/Lit"
{
	Properties
	{
		[TextureKeyword(_DEBUG)]
		_DEBUG_TEXTURE("Debug Texture", 2D) = "black" {}
		[TextureKeyword(_DEBUG2)]
		_DEBUG_TEXTURE2("Debug Texture 2", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
            ...
            // -------------------------------------
            // Material Keywords
            #pragma shader_feature_local _DEBUG2
            #pragma shader_feature_local _DOUBLESIDED_ON
            #pragma shader_feature_local _NORMALMAP
            #pragma shader_feature_local _MASKSMAP
