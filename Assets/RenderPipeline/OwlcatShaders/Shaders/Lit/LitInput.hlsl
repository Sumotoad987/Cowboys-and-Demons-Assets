...
inline void InitializeStandardLitSurfaceData(float2 uv, float2 screenUv, out SurfaceData outSurfaceData)
{
    ...
    outSurfaceData.emission = SampleEmission(uv, albedoAlpha.rgb, _EmissionColor.rgb, masks.g, _EmissionColorScale*10, outSurfaceData.albedo);
